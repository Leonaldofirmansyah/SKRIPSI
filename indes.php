...
<nav class="navbar navbar-expand-lg navbar-custom">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="view_pesanan.php">Pembelian</a>
            </li>
            <li class="nav-item">
                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Harga: <span class="font-weight-bold"><?= number_format($rowBarang['harga_item'], 2, ",", ".") ?></span></p>
                                <p class="card-text">Stok: <span class="font-weight-bold"><?= $rowBarang['stok_item'] ?></span></p>
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean laoreet lacus nec tempus sodales.</p>
                                <a href="pesanan.php?kode=<?= base64_encode($rowBarang['kode_item']) ?>" class="btn btn-primary">Beli</a>
                            </div>
                        </div>
                    </div>
                    <?php }
