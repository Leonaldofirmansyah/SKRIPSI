...
if (isset($_SESSION['role']) && $_SESSION['role'] == 'Produksi') {
     ...
     <div class="sidebar">
        <div class="p-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="produksi.php">siapproduksi</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdownStock">
                        <li><a class="dropdown-item" href="produk_siap_produksi.php">Pesanan Siap Produksi</a></li>
